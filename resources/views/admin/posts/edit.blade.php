        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <x-media-picker name="featured_image_path" :apiUrl="route('admin.media.json')" :uploadUrl="route('admin.media.store')" :currentImage="$post->featured_image ? asset('storage/' . $post->featured_image) : null" />
