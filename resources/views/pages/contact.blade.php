...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center mb-12">
            ...
            <p class="mt-4 text-xl text-gray-500 dark:text-gray-400">Punya pertanyaan atau saran? Kami senang mendengar dari Anda</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 text-center">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">hello@modernblog.com</p>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 text-center">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Jakarta, Indonesia</p>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 text-center">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Sen - Jum, 09:00 - 17:00</p>
            </div>
        </div>
            ...
            <form class="space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" class="w-full input-field" placeholder="Nama lengkap Anda">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email</label>
                        <input type="email" class="w-full input-field" placeholder="email@contoh.com">
                    </div>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Subjek</label>
                    <input type="text" class="w-full input-field" placeholder="Subjek pesan">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pesan</label>
                    <textarea rows="5" class="w-full input-field" placeholder="Tulis pesan Anda di sini..."></textarea>
                </div>
