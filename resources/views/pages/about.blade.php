...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-extrabold text-gray-900 dark:text-white">{{ __('Tentang Kami') }}</h1>
            <p class="mt-4 text-xl text-gray-500 dark:text-gray-400">{{ __('Mengenal lebih dekat') }} {{ config('app.name') }}</p>
        </div>

        <div class="prose max-w-none">
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 mb-8">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Misi Kami') }}</h2>
                <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                    {{ config('app.name') }} {{ __('misi_paragraf_1') }}
                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 text-center">
                    ...
                    <h3 class="font-bold text-gray-900 dark:text-white mb-2">{{ __('Konten Berkualitas') }}</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('Artikel yang ditulis dengan riset mendalam dan penuh dedikasi') }}</p>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 text-center">
                    ...
                    <h3 class="font-bold text-gray-900 dark:text-white mb-2">{{ __('Komunitas') }}</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('Bergabung dengan komunitas pembaca dan penulis yang aktif') }}</p>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 text-center">
                    ...
                    <h3 class="font-bold text-gray-900 dark:text-white mb-2">{{ __('Teknologi Modern') }}</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('Dibangun dengan Laravel dan teknologi web terkini') }}</p>
                </div>
            </div>
        </div>
    </div>
